...
linuxdeployqt/AppRun "$APPDIR/usr/share/applications/dwarftherapist.desktop" -extra-plugins=styles/DarkStyle.so,styles/fusiondark.so -bundle-non-qt-libs -qmake=$QT_PREFIX/bin/qmake
